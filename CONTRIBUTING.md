...
zig build refusals-sql # nilo_sql's 88; refusals-config, -pw, -cache and -s3 for the rest
...
test`, and the SQL table's 88 on top of that for `test-all`. They stay there on
purpose.
