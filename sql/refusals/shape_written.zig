//! A shaped Row is an answer, and an answer is not written back: its parent's
//! columns belong to another table.
...
export fn refusal() void {
    _ = sql.deleteFor(OrderCard, @TypeOf(.{ .where = .{ .id = @as(i64, 1) } }));
}
