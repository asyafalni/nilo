...
The quickest one to develop against is SeaweedFS in a container, which is what CI runs, with [`bench/s3_setup.py`](../../bench/s3_setup.py) filling it with the bucket and objects the tests and the benchmark want:
