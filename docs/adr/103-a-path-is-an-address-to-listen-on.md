...
The proxy [ADR 027](027-tls-is-terminated-in-front.md) puts in front had to
...
`.trusted_proxies` ([ADR 102](102-a-proxy-is-trusted-by-which-one-it-is.md))
...
([ADR 062](062-where-a-connection-waits-is-what-it-costs.md)), so it is not
...
the running total in [ADR 017](017-the-trade-budget-has-four-axes.md) is
...
[ADR 062](062-where-a-connection-waits-is-what-it-costs.md) was written
