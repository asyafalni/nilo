# A version a handler names is an ETag

**Status:** accepted
**Topic:** [responses](../design/responses.md)
**Extends:** [ADR 023](./023-a-failure-mode-belongs-in-the-return-type.md),
whose family of return wrappers gains one that answers 304, and
[ADR 009](./009-static-files-are-held-in-memory-or-opened.md), whose
`If-None-Match` comparison now serves a body a handler built.
**Applies:** [ADR 017](./017-the-trade-budget-has-four-axes.md),
[ADR 031](./031-a-redirect-puts-its-status-in-the-type.md),
[ADR 157](./157-a-type-can-write-its-own-answer.md),
[ADR 188](./188-a-route-can-say-cache-this-answer-for-a-minute.md).
...
Hashing was refused up front by ADR 017: it means the body exists before the
