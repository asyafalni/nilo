...
([ADR 009](009-static-files-are-held-in-memory-or-opened.md)).
...
[ADR 076](076-a-frame-that-lies-about-its-length-is-not-sent.md) is the same
...
([ADR 062](062-where-a-connection-waits-is-what-it-costs.md)), so this is not
...
([ADR 019](019-a-request-that-lasts-is-still-one-request.md)).
