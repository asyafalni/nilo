...
([ADR 036](036-the-shape-of-a-query-is-settled-while-compiling.md)): a join,
...
That is the failure [ADR 007](007-no-recover-middleware.md) says nilo cannot
...
([ADR 115](115-a-boot-dials-the-connection-its-work-needs.md)) — was
...
([ADR 067](067-a-value-is-whatever-the-database-stores.md)).
