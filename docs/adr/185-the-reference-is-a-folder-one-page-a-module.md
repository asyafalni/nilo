# The reference is a folder, one page a module

**Status:** accepted
**Topic:** [docs-tooling](../design/docs-tooling.md)
**Extends:** [ADR 068](./068-the-guide-is-the-source-of-its-own-snippets.md)
...
- **The snippets table** in `build.zig` names the ten pages that carry a
  ...
  read. The walk from ADR 068's later amendment is what holds that list
