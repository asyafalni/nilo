...
([ADR 062](062-where-a-connection-waits-is-what-it-costs.md) is where the
...
([ADR 061](061-a-fitting-borrows-the-loop.md)), so it cannot name `Ctx` and
...
the one optional extra ([ADR 134](134-entropy-a-function-pointer-can-carry.md)).
...
([ADR 062](062-where-a-connection-waits-is-what-it-costs.md)) to save an arena bump
...
+2,416 that `hello` did not also pay ([ADR 017](017-the-trade-budget-has-four-axes.md)).
