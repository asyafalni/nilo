...
## Why this is the same failure as ADR 016, backwards

[ADR 016](./016-the-api-description-comes-from-the-signatures.md) was about a `Uuid`
...
([ADR 034](./034-a-binding-hands-its-failures-to-the-handler.md)). The two
...
distinction ADR 034 draws rather than a hole in it: reaching the schema ceiling
