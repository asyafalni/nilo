# 0269 — a response says when it was sent, and not that it stays open

**Status:** accepted
**Applies:** [ADR 0002](./0002-zio-as-the-engine-behind-the-bulkhead.md),
[ADR 0007](./0007-failure-box-bound-to-the-fiber.md),
...
of ADR 0007 is stated in `http/date.zig`: nothing between the clock read and
