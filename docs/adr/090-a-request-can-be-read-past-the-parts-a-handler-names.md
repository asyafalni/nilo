...
([ADR 085](./085-every-header-without-handing-out-the-head.md) closed the
...
points at somebody else's ([ADR 003](./003-request-arena-and-the-str-type.md)).
...
nilo does not speak TLS ([ADR 027](./027-tls-is-terminated-in-front.md)), so
...
[ADR 017](./017-the-trade-budget-has-four-axes.md) treats as an invariant.
...
named ([ADR 080](./080-a-websocket-handshake-is-same-origin-unless-the-route-says-otherwise.md)).
