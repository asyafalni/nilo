...
declares with `AsText` ([ADR 049](./049-a-column-type-can-come-from-outside-this-module.md)) — is
...
[ADR 051](./051-a-statement-that-is-a-constant-can-be-prepared-once.md). It now also
...
That is `db.checking`'s half, and ADR 051 already argues why closing one half
