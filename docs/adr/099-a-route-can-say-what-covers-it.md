...
[ADR 008](008-middleware-is-an-onion-of-ctx-functions.md) gave a route a way to say
...
Both work. What is wrong with them is the same thing ADR 008 said about a
...
([ADR 008](008-middleware-is-an-onion-of-ctx-functions.md)), so a route
