...
[ADR 050](./050-a-view-or-a-rowid-alias-is-not-a-nullable-column.md):
...
3. **`WITH RECURSIVE` — a tree or a graph walk.** Irreducible, and the only
   ...
   [ADR 036](./036-the-shape-of-a-query-is-settled-while-compiling.md)'s
...
4. **A data-modifying CTE** — `WITH gone AS (DELETE … RETURNING …) INSERT INTO
   ...
   [ADR 053](./053-a-round-trip-is-not-the-cost-worth-chasing.md).
