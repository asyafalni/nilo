...
[ADR 017](./017-the-trade-budget-has-four-axes.md)'s per-connection axis, and
...
one axis ADR 017 treats as hard, for every server, including the ones whose
...
[ADR 003](./003-request-arena-and-the-str-type.md)'s territory, and the option
