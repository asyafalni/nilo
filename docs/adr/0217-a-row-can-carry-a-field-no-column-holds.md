...
[ADR 0181](0181-a-field-name-is-a-spelling-too.md) made the Row the response
...
([ADR 0202](0202-a-document-is-its-value.md)), and that is the shape for a
...
field, for the reason ADR 0207 gave: Zig has no field attributes, and a
...
- the field has to have a default, because nothing else fills it and an
  undefined field in a Row is the failure ADR 0008 says nilo cannot recover
  from;
