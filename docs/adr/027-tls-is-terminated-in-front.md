...
[ADR 017](./017-the-trade-budget-has-four-axes.md) has two rows that are invariants rather than budgets: one allocation per request, and a stated memory cost per idle connection. Both are now measured and published — 1 allocation, 8,767 bytes.
