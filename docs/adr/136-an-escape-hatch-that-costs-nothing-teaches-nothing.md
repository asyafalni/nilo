...
[ADR 125](./125-a-row-that-owns-no-table.md) made this cheaper without
...
[ADR 124](./124-a-raw-statement-cannot-cast-what-it-did-not-write.md) binds
...
[ADR 131](./131-a-header-a-handler-can-be-given.md)'s neighbour problem and
