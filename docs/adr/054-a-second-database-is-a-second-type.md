...
([ADR 010](./010-shared-services-need-a-lock-from-the-bulkhead.md)). So
...
4. **Read-after-write safety.** A handler that writes and then reads gets its
   ...
   answer in [ADR 050](./050-a-view-or-a-rowid-alias-is-not-a-nullable-column.md),
...
[ADR 053](./053-a-round-trip-is-not-the-cost-worth-chasing.md) measured a
...
statement cache ([ADR 051](./051-a-statement-that-is-a-constant-can-be-prepared-once.md))
