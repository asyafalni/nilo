...
**Status:** accepted
**Topic:** [rate-limiting](../design/rate-limiting.md)
...
([ADR 092](092-an-allowance-is-a-table-sized-while-compiling.md)). What was
missing is the key.
...
Both hashes come off the per-process seed ADR 092 already sets, so the mapping
...
window, one copy of the four-way eviction, one copy of ADR 092's
