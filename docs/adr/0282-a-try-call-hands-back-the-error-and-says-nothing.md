# 0282 — a `try` call hands back the error and says nothing

**Status:** accepted
**Extends:** [ADR 0002](./0002-zio-as-the-engine-behind-the-bulkhead.md)
(a load that stops the process says why in one line)
**Applies:** [ADR 0010](./0010-static-files-are-held-in-memory.md)
...
there is nobody else to give it to (ADR 0002). `app.tryStatic` is the same
