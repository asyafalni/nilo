# 0266 — a refused request is hung up on with a FIN
...
[ADR 0094](./0094-a-header-is-answered-as-asked-or-refused.md).
...
slow-client deadline in ADR 0023 already accepts.
...
to the end so that the 413 arrives is work the client sizes, and ADR 0018's
