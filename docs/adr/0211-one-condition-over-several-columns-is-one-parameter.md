...
`sql.given` writes the filters ([ADR 0183](0183-a-filter-that-is-absent-is-not-a-filter-that-is-null.md)),
...
constant ([ADR 0039](0039-the-shape-of-a-query-is-settled-while-compiling.md)).
...
however the box is set, which is ADR 0183's property carried to the bracket.
