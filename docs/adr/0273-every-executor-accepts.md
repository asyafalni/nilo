...
[ADR 0271](./0271-a-backlog-is-sized-for-the-burst-not-the-load.md),
[ADR 0272](./0272-a-connection-is-served-by-the-thread-it-was-dealt-to.md).
...
old backlog, 4,096 / 42.6K = 96 ms at the new one. ADR 0271's larger
...
- **A listener failure is kept, not returned.** An acceptor that sees an
  ...
  ADR 0265's descriptor-shortage backoff stays, per acceptor, with the
...
**The property ADR 0272 gave a handler** — one OS thread from first line
