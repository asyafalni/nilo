# A header is answered as asked, or refused
...
something else. This is the call [ADR 034](./034-a-binding-hands-its-failures-to-the-handler.md)
...
it ([ADR 057](./057-percent-is-needed-by-two-layers.md)). It is refused instead
...
([ADR 062](./062-where-a-connection-waits-is-what-it-costs.md), and now
...
**That is withdrawn rather than reported**, for the reason ADR 062 withdrew the
...
disclosure ADR 017 asks for rather than a defence of it.
