# A checkbox is a bool in a form, and nowhere else
...
quoted, on the four examples ADR 029 used:
...
compiled to before, down to the byte. That is unlike ADR 029, where the
...
Nothing to add to ADR 017's running total.
