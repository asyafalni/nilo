...
**+13ns, about 2% of a 600ns request.** ADR 017 sets the bar at 10% and says DX wins below it, so this is a trade that ADR already made; it is written down here so nobody has to rediscover the size of it.
