...
ADR 004 decided that a fail function stores its message in "the request currently running". It did not say how it knows which request that is. That turns out to be the easiest part to get wrong.
