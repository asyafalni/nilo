...
[ADR 0171](0171-a-row-over-there-is-a-condition.md) read the join out of the
...
is the shape [ADR 0211](0211-one-condition-over-several-columns-is-one-parameter.md)
...
ADR 0171's two Refusals stand — nothing declared, and declared twice — and
...
Row — but usually is the word ADR 0171 refused, and the two queries answer
...
Nothing. The statement is a constant the way ADR 0171's was; `correlation`
