# 0262 — a Db with no schema check says so, or is told
...
first.
**Applies:** [ADR 0039](./0039-the-shape-of-a-query-is-settled-while-compiling.md),
[ADR 0178](./0178-a-suite-whose-database-is-down-is-not-a-suite-that-failed.md).
...
`err` for the reason every line in `nilo_start` is one (ADR 0178): a
