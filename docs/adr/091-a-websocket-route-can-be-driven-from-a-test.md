...
([ADR 086](./086-the-test-client-can-do-what-a-client-does.md)). A WebSocket
...
[ADR 070](./070-a-request-nobody-else-would-answer-is-refused.md) says is not worth having.
