# 0278 — a raw placeholder is spelled for the dialect, and counted

**Status:** accepted
**Extends:** [ADR 0148](./0148-a-raw-statement-is-counted-while-compiling.md)
(the text of a raw statement is read while compiling)
**Applies:** [ADR 0061](./0061-the-second-dialect-is-the-test-of-the-seam.md)
