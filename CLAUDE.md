...
- **`docs/adr/`** — 217 binding decisions, each naming the alternative it
...
and the seven `refusals` steps check the wording of 281 error messages. Prefer making
...
zig build refusals-sql # nilo_sql's 105; also run by test-sql
