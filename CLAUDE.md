...
- **`docs/adr/`** — 213 binding decisions, each naming the alternative it
...
and the seven `refusals` steps check the wording of 272 error messages. Prefer making
...
zig build refusals-sql # nilo_sql's 96; also run by test-sql
