...
<p align="center">
  ...
  <a href="./refusals/README.md"><img alt="272 refusals" src="https://img.shields.io/badge/mistakes%20refused%20while%20compiling-272-e05d44?style=flat-square"></a>
  <a href="./docs/adr/"><img alt="213 ADRs" src="https://img.shields.io/badge/decisions%20on%20file-213-6b7280?style=flat-square"></a>
...
| **272 refusals** | mistakes that stop the build with a sentence nilo wrote, held by seven build steps. |
...
So this repository has **272 programs that are supposed to fail to compile**,
