//! A handler asking to be cached twice ([ADR 0247](../docs/adr/0247-a-route-can-say-cache-this-answer-for-a-minute.md)).
...
fn page(a: nilo.Cached(Pages, .{ .ttl_s = 60 }), b: nilo.Cached(Pages, .{ .ttl_s = 60 })) u32 {
